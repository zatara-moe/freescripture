...
(function () {
  ...
  var OPTIONS = [
    ...
    { key: "words", label: "Word help", choices: [
      { val: "on", label: "Show" },
      { val: "off", label: "Hide" },
    ]},
    ...
    { key: "turn", label: "Page turn", choices: [
    ...
    OPTIONS.forEach(function (opt) {
      ...
      opt.choices.forEach(function (choice) {
        ...
        btn.addEventListener("click", function () {
          ...
          /* Switching between scrolling and pages changes the whole
             screen, so step out of the way and let the reader see it. */
          if (opt.key === "reading") close();
        });
