/* Free Scripture — service worker
   ...
   offline the next time. All four translations. Search indexes are
   cached the first time someone searches, not on install, to save data. No tracking, no
   analytics, no external pings — reads stay on the device.
*/

var SHELL = 'freescripture-shell-v40';
var PAGES = 'freescripture-pages-v22';
var ASSETS = 'freescripture-assets-v17';
...
var PRECACHE = [
  ...
  '/about/',
  '/bsb/',
  '/static/css/site.css?v=49',
  '/static/js/reading-prefs.js?v=13',
  '/static/js/chapter.js?v=9',
  '/static/js/learn.js?v=4',
  '/static/js/stories.js?v=2',
  '/static/js/timeline.js?v=1',
  '/static/js/search.js?v=3',
  '/static/js/shortcuts.js?v=2',
  '/static/favicon.svg',
